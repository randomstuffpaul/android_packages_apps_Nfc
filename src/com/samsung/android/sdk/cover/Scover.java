...
public final class Scover implements SsdkInterface {
    ...
    public String getVersionName() {
        return String.format("%d.%d.%d", new Object[]{Integer.valueOf(1), Integer.valueOf(0), Integer.valueOf(0)});
    }
    ...
    public boolean isFeatureEnabled(int type) {
        ScoverManager coverManager = new ScoverManager(this.mContext);
        return coverManager != null ? coverManager.isSupportTypeOfCover(type) : false;
    }
}
